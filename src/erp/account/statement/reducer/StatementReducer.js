...
export const selectAccountTinfoRequest = createAction(SEARCH_ACCOUNT_TINFO_REQUEST,({startDate,endDate,accountCode})=>({startDate,endDate,accountCode})); //코드다이알로그조회
...
const StatementReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        ...state,
        isLoading: false,
        LedgerByAccountList: action.payload.gridRowJson
