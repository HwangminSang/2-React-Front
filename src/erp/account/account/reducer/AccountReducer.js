...
export const UPDATE_SLIP_SUCCESS = "src/erp/account/Saga/Saga/UPDATE_SLIP_SUCCESS"; //전표 UPDATE
...
export const selectSlipStart = createAction(SELECT_SLIP_START, ({startDate,endDate,slipStatus})=>({startDate,endDate,slipStatus}) ); //전표조회
...
export const deleteSlipStart = createAction(DELETE_SLIP_START, slipNo => slipNo); //전표삭제
...
export const updateSlipStart = createAction(UPDATE_SLIP_START,({slipType,expenseReport,slipNo})=>({slipType,expenseReport,slipNo})); //전표 update
...
export const selectJournalStart = createAction(SELECT_JOURNAL_START , slipNo=>slipNo) ; //분개조회
...
export const saveJournalStart = createAction(SAVE_JOURNAL_START , slipData=>slipData); //분개저장 insert
export const saveJournalFailure = createAction(SAVE_JOURNAL_FAILURE);

export const updateJournalStart = createAction(UPDATE_JOURNAL_START,({journalList})=>({journalList})); //분개저장 update
...
export const searchJournalDetailStart = createAction(SELECT_JOURNAL_DETAIL_START, journalNo=>journalNo); //분개상세조회
...
export const saveJournalDetailStart = createAction(SAVE_JOURNAL_DETAIL_START, SaveJournalDetailList=>SaveJournalDetailList); //분개상세저장
...
export const searchAmSlipStart = createAction(SEARCH_AM_SLIP_REQUEST,({startDate,endDate,slipStatus})=>({startDate,endDate,slipStatus}));
...
export const searchAmJournalStart = createAction(SEARCH_AM_JOURNAL_REQUEST,({slipNo})=>({slipNo}));
...
export const updateAmSlipStart = createAction(UPDATE_AM_SLIP_REQUEST,({approvalData})=>({approvalData}));
...
export const setJournalNoStart = createAction(SET_JOURNAL_NO_REQUEST,({journalNo})=>({journalNo}));
...
export const selectGeneralAccountLedgerStart = createAction(SELECT_GENERAL_ACCOUNT_LEDGER_START,({startDate,endDate})=>({startDate,endDate}));
...
export const searchJournalDoubleStart = createAction(SEARCH_JOURNAL_DOUBLE_REQUEST,({startDate,endDate})=>({startDate,endDate}));
...
const AccountReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case SELECT_SLIP_SUCCESS: //전표조회성공
        return {
          ...state,
          slipFormList: action.payload.slipList,
          journalList: [], //분개 값비움
     ...
     case UPDATE_SLIP_FAILURE: //전표 UPdate
      ...
      case SEARCH_AM_SLIP_SUCCESS:
        ...
        return {
          ...state,
          slipList: action.payload.slipList,
        };
    ...
    return {
        ...state,
        journalDoubleList: action.payload.journalDoubleList
    };
